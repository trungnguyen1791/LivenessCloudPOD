...
Pod::Spec.new do |spec|
  ...
  spec.source            = { :http => 'https://github.com/trungnguyen1791/LivenessCloudPOD/releases/download/1.0.0/LivenessUtility.zip' }
  ...
  spec.dependency "SwiftOTP", '~> 3.0.2'
  spec.dependency "SignManager", '~> 1.0.4'
